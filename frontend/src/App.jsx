...
import LabOrderDashboard from "./Components/Lab/Dashboard/LabOrderDashboard";
import LabResultsOverview from "./Components/Lab/Results/LabResultsOverview";
import AdverseReactionReport from "./Components/Lab/Reports/AdverseReactionReport";
import PharmacyInventory from "./Components/Pharmacy/Inventory/PharmacyInventory";
import LabStafNav from "./Components/Lab/Staff/LabStafNav";
import DoctorReview from "./Components/Lab/Review/DoctorReview";
import PaymentCenter from "./Components/Lab/Payment/PaymentCenter";
import InvoiceDetails from "./Components/Lab/Billing/InvoiceDetails";
import BillingManagement from "./Components/Lab/Billing/BillingManagement";
import ViewLabResults from "./Components/Lab/Patient/ViewLabResults";
import ViewPrescriptions from "./Components/Lab/Patient/ViewPrescriptions";
    ...
    <div>
      <React.Fragment>
        <Routes>
          ...
          {/*=======================================LAB======================================= */}
          <Route path="/labOrders" element={<LabOrderDashboard />} />
          <Route path="/labResults" element={<LabResultsOverview />} />
          <Route path="/adverseReactions" element={<AdverseReactionReport />} />
          <Route path="/pharmacyInventory" element={<PharmacyInventory />} />
          <Route path="/doctorReviews" element={<DoctorReview />} />
          <Route path="/billing" element={<BillingManagement />} />
          <Route path="/billing/invoice/:id" element={<InvoiceDetails />} />
          {/*=======================================LAB (PATIENT SIDE)======================================= */}
          <Route path="/myLabResults" element={<ViewLabResults />} />
          <Route path="/myPrescriptions" element={<ViewPrescriptions />} />
        </Routes>
      </React.Fragment>
    </div>
  );
