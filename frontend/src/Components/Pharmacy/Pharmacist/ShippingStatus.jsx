        ...
        <div className="pharmacy_from_full">
          ...
          <form className="pharmacy-form" onSubmit={handleSubmit}>
            <div className="input_group">
              ...
              <div className="form-group">
                <label className="form-label">Patient ID:</label><br/>
                <input
                  type="text"
                  name="patientID"
                  className="form-input"
            ...
            <div className="input_group">
              <div className="form-group">
                <label className="form-label">Order ID:</label><br/>
                <input
                  type="text"
                  name="OrderID"
                  id="OrderID"
            ...
            <div className="input_group">
              <div className="form-group">
                <label className="form-label">Gmail:</label><br/>
                <input
                  type="email"
                  name="gmail"
                  className="form-input"
              ...
              <div className="form-group">
                <label className="form-label">Pharmacy Name:</label><br/>
                <input
                  type="text"
                  name="pharmacyname"
                  className="form-input"
            ...
            <div className="input_group">
              <div className="form-group">
                <label className="form-label">Delivery Method:</label><br/>
                <input
                  type="text"
                  name="deliveryMethod"
                  className="form-input"
            ...
            <div className="input_group">
              ...
              <div className="form-group">
                ...
                <select
                  ...
                  required
                >
                  <option value="">Select a shipping Status</option>
            ...
            <div className="form-group">
              <label className="form-label">Prescription:</label><br/>
              {currentImage && (
                <div>
                  <img
