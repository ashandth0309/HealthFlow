...
function DentalDoctorLogin() {
    ...
    const handleLogin = (e) => {
      ...
      if (username === validUsername && password === validPassword) {
        ...
        window.location.href = "/myAppointmentDoctor"; 
      } else {
        alert("Invalid login");
      }
    };
  return (
    <div>
      ...
      <div >
      <h3 className="login_topic">dental doctor Login</h3>
...
export default DentalDoctorLogin
